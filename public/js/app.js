...
__webpack_require__(/*! ./script */ "./resources/js/script.js"); // dropzone
...
function counters() {
  var recensioniPositive = document.querySelector('#recensioniPositive');
  var recensioniPositiveCounter = 0;
  var recensioniPositiveInterval = setInterval(function () {
    recensioniPositiveCounter++;
    recensioniPositive.innerHTML = "".concat(recensioniPositiveCounter);

    if (recensioniPositiveCounter > 367) {
      clearInterval(recensioniPositiveInterval);
    }
  }, 0.3);
  var prodottiVendutiCounter = 300;
  var prodottiVenduti = document.querySelector('#prodottiVenduti');
  var prodottiVendutiinterval = setInterval(function () {
    prodottiVendutiCounter++;
    prodottiVenduti.innerHTML = "".concat(prodottiVendutiCounter);

    if (prodottiVendutiCounter > 1259) {
      clearInterval(prodottiVendutiinterval);
    }
  }, 0.07);
  var annunciInseritiCounter = 0;
  var annunciInseriti = document.querySelector('#annunciInseriti');
  var annunciInseritiInterval = setInterval(function () {
    annunciInseritiCounter++;
    annunciInseriti.innerHTML = "".concat(annunciInseritiCounter);
